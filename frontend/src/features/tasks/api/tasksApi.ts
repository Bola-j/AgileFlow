...
export const tasksApi = {
  ...
  updateStatus: async (id: number, payload: UpdateTaskStatusRequest) => (await apiClient.put<TaskDetailResponse>(`/api/tasks/${id}/status`, payload)).data,
  submit: async (id: number, payload: SubmitTaskRequest) => (await apiClient.post<TaskDetailResponse>(`/api/tasks/${id}/submit`, payload)).data,
  review: async (id: number, payload: ReviewTaskRequest) => (await apiClient.put<TaskDetailResponse>(`/api/tasks/${id}/review`, payload)).data,
