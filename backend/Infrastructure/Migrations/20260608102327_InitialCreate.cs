        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Github_Username = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWorkspaces", x => new { x.AppUserId, x.WorkspaceId });
                    table.ForeignKey(
                        name: "FK_UserWorkspaces_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectTasks_BoardColumns_ColumnId",
                        column: x => x.ColumnId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commits_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Commits_ProjectTasks_ProjectTaskId",
                        column: x => x.ProjectTaskId,
                        principalTable: "ProjectTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskActivityLogs_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskActivityLogs_ProjectTasks_ProjectTaskId",
                        column: x => x.ProjectTaskId,
                        principalTable: "ProjectTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DependedTaskId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskDependents", x => new { x.TaskId, x.DependedTaskId });
                    table.ForeignKey(
                        name: "FK_TaskDependents_ProjectTasks_DependedTaskId",
                        column: x => x.DependedTaskId,
                        principalTable: "ProjectTasks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskDependents_ProjectTasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "ProjectTasks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTasks", x => new { x.AppUserId, x.ProjectTaskId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commits_AppUserId",
                table: "Commits",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Commits_ProjectTaskId",
                table: "Commits",
                column: "ProjectTaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskActivityLogs_AppUserId",
                table: "TaskActivityLogs",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskActivityLogs_ProjectTaskId",
                table: "TaskActivityLogs",
                column: "ProjectTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskDependents_DependedTaskId",
                table: "TaskDependents",
                column: "DependedTaskId");
